...
const renameFile = (item, itemPath, folderPath) => {
    const renameMap = [
        ...
        { condition: '2._Site_Assessment', newName: '2. Site Assessment' },
        { condition: 'site assessment', newName: '2. Site Assessment' },
        { condition: 'SA', newName: '2. Site Assessment' },
        { condition: 'taxInvoice', newName: '3. Tax Invoice' },
        { condition: 'Tax_Invoice', newName: '3. Tax Invoice' },
        { condition: 'receipt', newName: '4. Proof of Payment' },
        { condition: '4._Receipt', newName: '4. Proof of Payment' },
        { condition: '4._Proof_of_Payment', newName: '4. Proof of Payment' },
        { condition: 'Coc', newName: '5. CoC' },
        { condition: '5._CoC', newName: '5. CoC' },
        { condition: 'postImplementation', newName: '6. Post Implementation' },
        { condition: '6._Post_Implementation', newName: '6. Post Implementation' },
        ...
        { condition: '7._Proof_of_Decomission', newName: '7. Proof of Decommission', moveToParent: false },
        { condition: '7._Proof_of_decomission', newName: '7. Proof of Decommission', moveToParent: false },
        { condition: '7._Proof_of_Decommission', newName: '7. Proof of Decommission', moveToParent: false },
        { condition: 'Compliance Form', newName: '0. Compliance Form.pdf' },
        { condition: '0._Compliance_Form', newName: '0. Compliance Form.pdf' },
        { condition: 'Calculation Output', newName: '0. Calculation Output (HEERs)' },
        { condition: '0._Calculation_Output_(HEERs)', newName: '0. Calculation Output (HEERs)' },
